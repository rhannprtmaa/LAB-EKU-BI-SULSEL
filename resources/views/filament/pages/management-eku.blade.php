<x-filament-panels::page>
    <div x-data="{ activeTab: 'deadline' }" class="space-y-6">
        ...
        {{-- TAB 2: BATASAN EKU PER BANK (MENGGUNAKAN FILAMENT TABLE) --}}
        <div x-show="activeTab === 'batasan'" class="space-y-6">
            <div class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="mb-4 pb-3 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="text-lg font-bold text-gray-900 dark:text-white">Pengaturan Batasan EKU per Bank</h2>
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        Klik tombol <strong>Edit</strong> untuk mengatur nilai batasan dan mengunggah dokumen referensi (PDF/Excel) per bank.
                        Sistem otomatis menyesuaikan nilai pengajuan EKU bila batasan diubah.
                    </p>
                </div>

                {{-- Komponen Tabel Bawaan Filament --}}
                {{ $this->table }}
            </div>
        </div>

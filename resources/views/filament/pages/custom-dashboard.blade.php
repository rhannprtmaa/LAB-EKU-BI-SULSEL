<x-filament-panels::page>
        ...
        <div class="flex items-center gap-3">
            ...
            @if (filament()->auth()->check())
                @if (filament()->hasDatabaseNotifications())
                    @livewire(
                        filament()->getDatabaseNotificationsLivewireComponent(),
                        [
                ...
                {{-- User menu dihapus karena menyebabkan error pada Filament 5 --}}
            @endif
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        @foreach ($this->getStats() as $stat)
            <div class="rounded-2xl p-5 {{ $colorMap[$stat['color']]['bg'] }} border border-black/5 shadow-sm hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <x-dynamic-component
                        :component="$stat['icon']"
                        class="w-5 h-5 {{ $colorMap[$stat['color']]['text'] }}"
                    />
                </div>
    ...
    <div class="mt-6 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-5">
        {{ $this->form }}
    </div>
        ...
        @else
            ...
            @if (! $chart['hasData'])
                ...
                <div class="flex flex-col items-center justify-center py-16 text-center text-gray-400">
                    ...
                    <p class="text-sm max-w-sm mt-1">
                        Grafik Forecast EKU hanya menampilkan data yang sudah divalidasi &amp; disetujui User BI.
                    </p>
